...
@section('content')
    <div class="container p-3 mt-4">
        <div class="d-flex my-3">
            ...
            <form class="d-flex my-2 ms-auto" action="/masyarakat/transaksi/riwayat" method="get">
        ...
        @if ($auctions->isEmpty())
            <div class="alert alert-info" role="alert">
                Anda belum pernah memenangkan lelang!
            </div>
        @else
                ...
                @foreach ($auctions as $auction)
                    ...
                    <div class="col">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <a href="/masyarakat/transaksi/riwayat/{{ $auction->id }}" class="btn btn-success w-100">
                                    Detail Lelang
                                </a>
                            </div>
                        </div>
